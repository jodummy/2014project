	...
	<div class="col-sm-10 text-left">
		<div class="col-sm-12">
			...
			<div class="totalpadleft">
				...
				<form action="./doclistimsiMine00.do" method="post" id='frmPaging'>
					<table class="table table-bordered">
						<tr>
							<td style="width:15%">문서 관리 번호</td>
							<td style="width:65%">제 목</td>
							<td style="width:20%">작 성 일</td>
						</tr>
						<c:forEach items="${imsilist}" var="doc">
							<tr>
								<td>${doc.doc_mngno}</td>
								<td><a onclick="detailImsi(${doc.doc_mngno})">${doc.doc_title}</a></td>
