		...
		<div class="col-sm-10 text-left">
			<div class="col-sm-12">
				<div class="totalpadleft">
					...
					<div class="selectdoccount" align="right">
					...
					<form action="./doclistTotal00.do" method="post" id='frmPaging'>
						<table class="table table-bordered">
							<tr>
								<td style="width: 10%">문서상태</td>
								<td style="width: 17%">문서번호</td>
						...
						<input type='hidden' id='pageLastNum'
							value='${paging.pageLastNum}' />
					</form>
