	...
	<div class="col-sm-10 text-left">
		<div class="col-sm-12">
			<div class="totalpadleft">
				...
				<form action="./doclistWait00.do" method="post" id='frmPaging'>
					<table class="table table-bordered">
						...
						<c:forEach items="${doclist}" var="doc">
							<tr>
								<td>${doc.doc_mngno}</td>
								<td>${doc.doc_no}</td>
								<td><a onclick="detailApp(${doc.doc_mngno})">${doc.doc_title}</a></td>
