...
<script type="text/javascript">
	...
	function insertUser() {
		window.open("./insertUser.do", "선택",
						"scrollbars=yes,toolbar=yes,resizable=yes,width=450,height=500,right=150,top=0");
	}
	
	function detailUser(mem_email) {
		window.open("./detailUser.do?&mem_email=" + mem_email, "선택",
						"scrollbars=yes,toolbar=yes,resizable=yes,width=450,height=500,right=150,top=0");
	}
	...
	<div class="col-sm-10 text-left">
		<div class="col-sm-12">
			<div style="padding-left: 50px;">
				...
				<form action="./mainUser.do" method="post" id="frmPaging">
					<table class="table table-bordered table-hover">
						...
						<c:forEach items="${key}" var="nn">
							<tr>
								...
								<th>${nn.mem_tel}</th>
								<th>${nn.dept_no}</th>
								<th>${nn.mem_ragdate}</th>
								<th><input type="button" value="조회"
									onclick="detailUser('${nn.mem_email}')"
